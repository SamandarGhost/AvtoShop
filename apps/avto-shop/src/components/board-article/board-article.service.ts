...
export class BoardArticleService {
    ...
    //     if (!targetBoardArticle) throw new InternalServerErrorException(Message.N0_DATA_FOUND);
    ...
    public async updateBoardArticle(memberId: ObjectId, input: BoardArticleUpdate): Promise<BoardArticle> {
        ...
        const result = await this.boardArticleModel.findOneAndUpdate(
            { _id: _id, memberId: memberId, articleStatus: BoardArticleStatus.ACTIVE }, input, { new: true }
        ).exec();
    ...
    public async updateBoardArticleByAdmin(input: BoardArticleUpdate): Promise<BoardArticle> {
        ...
        const result = await this.boardArticleModel.findOneAndUpdate(
            { _id: _id, articleStatus: BoardArticleStatus.ACTIVE }, input, { new: true }
        ).exec();
    ...
    public async removeBoardArticleByAdmin(articleId: StatisticModifier): Promise<BoardArticle> {
